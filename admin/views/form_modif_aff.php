<form method="post" action="index.php?action=modifier_affiche">
	...
	<table id="post">	
		...
		<tr>
			...
			<td>
				<input type="hidden" value=<?php echo '"'.$contenu['id_zone'].'"';?> name="id_zone" />
				<input type="hidden" value=<?php echo '"'.$contenu['date'].'"';?> name="date" />
